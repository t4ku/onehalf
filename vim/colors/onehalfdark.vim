...
" https://github.com/sonph/onehalf/issues/90
call s:h("DiffAdd", s:green, s:comment_fg, "")
call s:h("DiffChange", s:yellow, s:comment_fg, "")
call s:h("DiffDelete", s:red, s:comment_fg, "")
call s:h("DiffText", s:blue, s:comment_fg, "")
